"""
Django settings for gestion_flotas project.
...
SECRET_KEY = 'django-insecure-i5f!)n%)^v_uek9wes$2$8rix-&ecie2l419ipx+l7lkblpn18'
...
LOGOUT_REDIRECT_URL = '/'  # Para redirigir después del logout
